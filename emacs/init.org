  ...
  (use-package dashboard
    ...
    (progn
      ...
      (setq dashboard-banner-logo-title "[ E M A C S ]"
            dashboard-startup-banner "~/Pictures/batman_kick.png" ;; replace 'logo with AWESOME
...
** Font
Emacs 28 seems t o be disrespecting my choices made via the options UI, so doing this in elisp.
#+begin_src emacs-lisp
