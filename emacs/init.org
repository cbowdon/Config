...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package flycheck)  ;; used by lsp-ui for fancy displays
...
** Python
I used to like Elpy for this, but these days prefer anaconda-mode because it's more lightweight.
#+BEGIN_SRC emacs-lisp
  (defmodule python3
    "Init module for Python 3 development. Installs and configures anaconda-mode."
...
#+BEGIN_SRC emacs-lisp
  (defmodule java
    ...
    (use-package lsp-java :config (add-hook 'java-mode-hook 'lsp-java-enable))
