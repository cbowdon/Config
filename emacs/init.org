...
** Clojure sans CIDER
CIDER is amazing, but you can get 80% of the benefits with 1% of the code, so I'm trying out this setup from [[https://martintrojer.github.io/clojure/2014/10/02/clojure-and-emacs-without-cider][Martin Trojer]].
#+BEGIN_SRC emacs-lisp
  (defmodule clojure-sans-cider
    ...
    (use-package company-etags
      :config (add-to-list 'company-etags-modes 'clojure-mode))
