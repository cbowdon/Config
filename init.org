...
#+BEGIN_SRC emacs-lisp
  (defun init-file ()
    (interactive)
    (cond ((eq system-type 'windows-nt) "C:/Cygwin64/home/chris.bowdon/init.org")
          (t "~/init.org")))
...
** MacOS
*** Terminal colors
[[http://stackoverflow.com/questions/8918910/weird-character-zsh-in-emacs-terminal/8920373#8920373][=term= and =ansi-term= on MacOS needs a bit of setup.]]
#+BEGIN_SRC emacs-lisp
